        ...
        return {
            ...
            template: function () {
                return [
                    ...
                    '            <snav-item ng-click="vm.selected = vm.TYPE_TRENDING" value="{{vm.TYPE_TRENDING}}" class="margin-left-xlarge" i18n="home/trending"></snav-item>',
                    '            <snav-item ng-click="vm.selected = vm.TYPE_MINE" value="{{vm.TYPE_MINE}}" class="logged-in-only--display" i18n="home/your_stuff"></snav-item>',
                    '        </snav>',
                    '        <hr>',
