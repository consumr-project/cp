    ...
    function (DOMAIN, $q, $timeout, lodash, utils, i18n, ServicesService, SessionService) {
        ...
        function generate_template_event_content(label) {
            return [
                ...
                '            class="events__event__meta imgview imgview--with-content">{{event.bookmark_count | number}}</span>',
        ...
        return {
            ...
            template: [
                ...
                '                    class="imgview imgview--dot-dot-dot no-outline"></span>',
                '                <span ng-class="{',
                '                        \'imgview--bookmarks\': !event.bookmarked_by_me,',
                '                        \'imgview--bookmarked\': event.bookmarked_by_me,',
                '                    }"',
                '                    ng-click="toggle_favorite($event, event)"',
                '                    class="events__event__meta imgview margin-right-xsmall">&nbsp;</span>',
                '            </div>',
                '            <event',
                '                type="view"',
